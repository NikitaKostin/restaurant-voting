...
import static ru.javadiploma.restaurantvoting.DishTestData.dish7;
...
public class MenuItemTestData {
    ...
    public static final MenuItem MENU_ITEM_1 = new MenuItem(MENU_ITEM_1_ID, LocalDate.of(2023, Month.APRIL, 4));
    public static final MenuItem MENU_ITEM_2 = new MenuItem(MENU_ITEM_2_ID, LocalDate.of(2023, Month.APRIL, 5));
    public static final MenuItem MENU_ITEM_3 = new MenuItem(MENU_ITEM_3_ID, LocalDate.of(2023, Month.APRIL, 4));
    public static final MenuItem MENU_ITEM_4 = new MenuItem(MENU_ITEM_4_ID, LocalDate.of(2023, Month.APRIL, 5));
    public static final MenuItem MENU_ITEM_8_NOW = new MenuItem(MENU_ITEM_8_ID, LocalDate.now());
    public static final MenuItem MENU_ITEM_9_NOW = new MenuItem(MENU_ITEM_9_ID, LocalDate.now());
