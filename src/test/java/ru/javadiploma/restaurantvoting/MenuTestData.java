...
public class MenuTestData {
    ...
    public static final Menu menu1 = new Menu(MENU_1_ID, LocalDate.of(2023, Month.APRIL, 4));
    public static final Menu menu2 = new Menu(MENU_2_ID, LocalDate.of(2023, Month.APRIL, 5));
    public static final Menu menu3 = new Menu(MENU_3_ID, LocalDate.of(2023, Month.APRIL, 4));
    public static final Menu menu4 = new Menu(MENU_4_ID, LocalDate.of(2023, Month.APRIL, 5));
    ...
    public static Menu getUpdated() {
        return new Menu(MENU_4_ID, dish7, restaurant1, LocalDate.of(2023, Month.APRIL, 5));
    }
