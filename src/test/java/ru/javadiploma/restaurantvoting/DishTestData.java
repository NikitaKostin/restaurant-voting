...
public class DishTestData {
    ...
    public static final Dish dish1 = new Dish(DISH_1_ID, "Burger", 35);
    public static final Dish dish2 = new Dish(DISH_2_ID, "Cheese Burger", 40);
    public static final Dish dish3 = new Dish(DISH_3_ID, "Cola", 8);
    public static final Dish dish4 = new Dish(DISH_4_ID, "Tea", 7);
    public static final Dish dish5 = new Dish(DISH_5_ID, "Margarita", 25);
    public static final Dish dish6 = new Dish(DISH_6_ID, "Chicago pizza", 35);
    public static final Dish dish7 = new Dish(DISH_7_ID, "Coffee", 8);
    public static final Dish dish8 = new Dish(DISH_8_ID, "Dish of the day", 30);
    public static final Dish dish9 = new Dish(DISH_9_ID, "Drink of the day", 5);
